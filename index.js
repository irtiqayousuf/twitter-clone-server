...
const uri = `mongodb+srv://irtiqayousuf786:irtiqa786@cluster0.notysls.mongodb.net/?retryWrites=true&w=majority`;
...
app.get('/', (req, res) => {
    res.send('Hello from Twitter Clone! this is made by irtiqa yousuf')
})
